                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($menuleveldua as $mld) : ?>
                                            <tr class="text-center">
                                                ...
                                                <?php endif; ?>
                                                <?php if ($mld['status_sub'] == 1) : ?>
                                                    <td>
                                                        <p>Tidak Ada Submenu Level 3</p>
                                                    </td>
                                                <?php elseif ($mld['status_sub'] == 0) : ?>
                                                    <td>
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>menu/editmenulevel2" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="icon">Icon</label>
                            <input type="text" class="form-control" id="icon" name="icon" placeholder="Submenu level 2 icon" autocomplete="off" value="<?php echo $mld['icon']; ?>">
                        </div>
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" name="is_active" id="is_active" checked>
