                    ...
                    <div class="card-body">
                        <div class="px-3">
                            ...
                            <div class="text-center auth-logo-text">
                                <h4 class="mt-0 mb-3 mt-5">Reset Password SatriaShop</h4>
                                <p class="text-muted mb-0">Masukkan email dan instruksi mengenai ganti password akan dikirim ke email kamu!</p>
                            </div>
                            <!--end auth-logo-text-->
                        ...
                        <div class="m-3 text-center text-muted">
                            <p class="">Masih ingat passwordnya ? <a href="<?php echo base_url('auth'); ?>" class="text-primary ml-2">Login disini</a></p>
                        </div>
                    </div>
                    <!--end card-body-->
                </div>
